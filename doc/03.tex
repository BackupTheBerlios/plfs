...
modo que cuando detecta una modificación sobre uno de dichos ficheros, \famon
avisa a \dplc (el cuál se encargará de avisar a los \dpld encargados del slice
acerca de la invalidación del fichero).
